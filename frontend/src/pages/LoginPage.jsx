...
export default function LoginPage() {
  const { login, verify2FA, cancel2FA, isAuthenticated, pending2FA, pending2FAData, getDefaultRoute } = useAuth();
  ...
  // Redirect if already authenticated - توجيه حسب الدور
  if (isAuthenticated) {
    ...
    try {
      ...
      if (result.requires_2fa) {
        ...
        if (result.must_change_password) {
          ...
          // توجيه حسب الدور بدل الإتجاه الثابت
