  ...
  const navSections = [
    {
      title: t('main'),
      items: [
        { name: getDashboardName(), path: '/dashboard', icon: LayoutDashboard, roles: ['admin', 'sales', 'accountant', 'hr', 'purchasing', 'project_manager'] },
      ],
    },
    {
      title: t('sales'),
      items: [
        { name: t('salesOrders'), path: '/orders', icon: ShoppingCart, roles: ['admin', 'sales', 'accountant'] },
    ...
    },
    {
      ...
      items: [
        ...
        { name: t('fiscalClosure'), path: '/fiscal-closure', icon: ClipboardCheck, roles: ['admin', 'accountant'] },
        { name: t('branches'), path: '/branches', icon: Building2, roles: ['admin', 'accountant'] },
        { name: t('currencies'), path: '/currencies', icon: Globe2, roles: ['admin', 'accountant'] },
        { name: t('costAllocation'), path: '/cost-allocation', icon: PieChart, roles: ['admin', 'accountant'] },
      ],
    },
    {
      title: t('hr'),
      items: [
        ...
        { name: t('departments'), path: '/departments', icon: Building2, roles: ['admin', 'hr'] },
        { name: t('attendance'), path: '/attendance', icon: ClipboardList, roles: ['admin', 'hr'] },
        { name: t('shifts'), path: '/shifts', icon: Clock, roles: ['admin', 'hr'] },
        { name: t('performance'), path: '/performance', icon: TrendingUp, roles: ['admin', 'hr'] },
        { name: t('payroll'), path: '/payroll', icon: Wallet, roles: ['admin', 'accountant', 'hr'] },
        { name: t('recruitment'), path: '/recruitment', icon: UserPlus, roles: ['admin', 'hr'] },
        { name: t('training'), path: '/training', icon: GraduationCap, roles: ['admin', 'hr'] },
        { name: t('orgChart'), path: '/org-chart', icon: Network, roles: ['admin', 'hr', 'sales', 'project_manager'] },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        { name: t('importExport'), path: '/import-export', icon: Globe2, roles: ['admin', 'purchasing'] },
      ],
    },
    {
      title: t('tenders'),
    ...
    {
      title: t('startupFinance'),
      items: [
        { name: t('founderDashboard'), path: '/founder-dashboard', icon: Rocket, roles: ['admin', 'accountant'] },
      ],
    },
    {
      title: t('admin'),
      items: [
        { name: t('notifications'), path: '/notifications', icon: Bell, roles: ['admin', 'sales', 'accountant', 'hr', 'purchasing', 'project_manager'] },
        { name: t('profile'), path: '/profile', icon: User, roles: ['admin', 'sales', 'accountant', 'hr', 'purchasing', 'project_manager'] },
        { name: t('users'), path: '/users', icon: Users, roles: ['admin'] },
        { name: t('videoInstructions'), path: '/video-instructions', icon: Video, roles: ['admin', 'sales', 'accountant', 'hr', 'purchasing', 'project_manager'] },
      ],
    },
    {
      title: t('system'),
    ...
    <div className={`flex h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-300`} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-[0_-2px_10px_rgba(0,0,0,0.08)] dark:shadow-[0_-2px_10px_rgba(0,0,0,0.3)]">
        <div className="flex items-center justify-around px-1 py-1">
          {[
            { name: t('dashboard'), path: '/dashboard', icon: LayoutDashboard, roles: ['admin', 'sales', 'accountant', 'hr', 'purchasing', 'project_manager'] },
            { name: t('salesOrders'), path: '/orders', icon: ShoppingCart, roles: ['admin', 'sales', 'accountant'] },
            { name: t('purchases'), path: '/purchases', icon: Truck, roles: ['admin', 'sales', 'accountant', 'purchasing'] },
            { name: t('employees'), path: '/employees', icon: UserCog, roles: ['admin', 'hr'] },
            { name: t('projects'), path: '/projects', icon: FolderKanban, roles: ['admin', 'sales', 'accountant', 'project_manager'] },
