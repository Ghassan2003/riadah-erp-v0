...
urlpatterns = [
    ...
    # Payment Accounts
    path('accounts/', PaymentAccountListView.as_view(), name='payment-account-list'),
    path('accounts/create/', PaymentAccountCreateView.as_view(), name='payment-account-create'),
    path('accounts/<int:pk>/', PaymentAccountDetailView.as_view(), name='payment-account-detail'),
    path('accounts/<int:pk>/update/', PaymentAccountUpdateView.as_view(), name='payment-account-update'),
    path('accounts/<int:pk>/delete/', PaymentAccountDeleteView.as_view(), name='payment-account-delete'),
