...
class AccountListSerializer(serializers.ModelSerializer):
    ...
    def get_has_children(self, obj):
        return getattr(obj, 'children_count', 0) > 0
...
# =============================================
# Trial Balance Serializers
# =============================================

class TrialBalanceAccountSerializer(serializers.Serializer):
    """Serializer for a single account row in trial balance."""

    account_code = serializers.CharField()
    account_name = serializers.CharField()
    account_type = serializers.CharField()
    total_debit = serializers.DecimalField(max_digits=16, decimal_places=2)
    total_credit = serializers.DecimalField(max_digits=16, decimal_places=2)
    balance = serializers.DecimalField(max_digits=16, decimal_places=2)
...
class TrialBalanceSerializer(serializers.Serializer):
    ...
    grand_total_debit = serializers.DecimalField(max_digits=16, decimal_places=2)
    grand_total_credit = serializers.DecimalField(max_digits=16, decimal_places=2)
...
class GeneralLedgerAccountSerializer(serializers.Serializer):
    """Serializer for account info in general ledger."""
...
class GeneralLedgerEntrySerializer(serializers.Serializer):
    """Serializer for a single entry line in general ledger."""

    entry_number = serializers.CharField()
    entry_date = serializers.DateField()
    description = serializers.CharField()
    debit_amount = serializers.DecimalField(max_digits=16, decimal_places=2)
    credit_amount = serializers.DecimalField(max_digits=16, decimal_places=2)
...
class GeneralLedgerSerializer(serializers.Serializer):
    ...
    account = GeneralLedgerAccountSerializer()
    date_from = serializers.DateField(required=False, allow_null=True)
    date_to = serializers.DateField(required=False, allow_null=True)
...
# =============================================
# Cash Flow Statement Serializers
# =============================================

class CashFlowItemSerializer(serializers.Serializer):
    """Serializer for a single item in cash flow section."""
...
class CashFlowSectionSerializer(serializers.Serializer):
    """Serializer for a section in cash flow (operating/investing/financing)."""

    items = CashFlowItemSerializer(many=True)
    net_amount = serializers.DecimalField(max_digits=16, decimal_places=2)


class CashFlowStatementSerializer(serializers.Serializer):
    """Serializer for cash flow statement report."""

    date_from = serializers.DateField(required=False, allow_null=True)
    date_to = serializers.DateField(required=False, allow_null=True)
    operating_activities = CashFlowSectionSerializer()
    investing_activities = CashFlowSectionSerializer()
    financing_activities = CashFlowSectionSerializer()
    net_change_in_cash = serializers.DecimalField(max_digits=16, decimal_places=2)


# =============================================
# VAT Return Serializers
# =============================================

class VATReturnSerializer(serializers.Serializer):
    """Serializer for VAT return report."""

    month = serializers.IntegerField()
    year = serializers.IntegerField()
    total_output_vat = serializers.DecimalField(max_digits=16, decimal_places=2)
    total_input_vat = serializers.DecimalField(max_digits=16, decimal_places=2)
    net_vat_payable = serializers.DecimalField(max_digits=16, decimal_places=2)
    sales_invoices_count = serializers.IntegerField()
    purchase_invoices_count = serializers.IntegerField()


# =============================================
# AR / AP Aging Serializers
# =============================================

class ARAgingCustomerSerializer(serializers.Serializer):
    """Serializer for a single customer in AR aging report."""

    customer_id = serializers.IntegerField()
    customer_name = serializers.CharField()
    current = serializers.DecimalField(max_digits=16, decimal_places=2)
    days_1_30 = serializers.DecimalField(max_digits=16, decimal_places=2)
    days_31_60 = serializers.DecimalField(max_digits=16, decimal_places=2)
    days_61_90 = serializers.DecimalField(max_digits=16, decimal_places=2)
    days_over_90 = serializers.DecimalField(max_digits=16, decimal_places=2)
...
class ARAgingSerializer(serializers.Serializer):
    """Serializer for AR aging report."""

    report_date = serializers.DateField()
    customers = ARAgingCustomerSerializer(many=True)
    grand_total_current = serializers.DecimalField(max_digits=16, decimal_places=2)
    grand_total_days_1_30 = serializers.DecimalField(max_digits=16, decimal_places=2)
    grand_total_days_31_60 = serializers.DecimalField(max_digits=16, decimal_places=2)
    grand_total_days_61_90 = serializers.DecimalField(max_digits=16, decimal_places=2)
    grand_total_days_over_90 = serializers.DecimalField(max_digits=16, decimal_places=2)
    grand_total_outstanding = serializers.DecimalField(max_digits=16, decimal_places=2)


class APAgingSupplierSerializer(serializers.Serializer):
    """Serializer for a single supplier in AP aging report."""
...
class APAgingSerializer(serializers.Serializer):
    """Serializer for AP aging report."""

    report_date = serializers.DateField()
    suppliers = APAgingSupplierSerializer(many=True)
    grand_total_current = serializers.DecimalField(max_digits=16, decimal_places=2)
    grand_total_days_1_30 = serializers.DecimalField(max_digits=16, decimal_places=2)
    grand_total_days_31_60 = serializers.DecimalField(max_digits=16, decimal_places=2)
    grand_total_days_61_90 = serializers.DecimalField(max_digits=16, decimal_places=2)
