...
Enhanced with Fiscal Closure, Multi-Currency/Branch, and Cost Allocation.
"""
...
urlpatterns = [
    ...
    path('closure/', include('accounting.closure_urls')),

    # Multi-Currency & Branches
    path('multi/', include('accounting.multicurrency_urls')),

    # Cost Allocation
    path('cost/', include('accounting.cost_allocation_urls')),
]
