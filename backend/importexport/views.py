...
class ImportItemListView(generics.ListAPIView):
    ...
    filter_backends = [filters.SearchFilter, filters.OrderingFilter]
    search_fields = ['description', 'hs_code', 'product_name']
    ordering_fields = ['description', 'quantity', 'unit_price', 'total_price', 'created_at']
    ordering = ['id']

    def get_queryset(self):
        queryset = ImportItem.objects.select_related('import_order')
...
class ImportItemDetailView(generics.RetrieveAPIView):
    ...
    def get_queryset(self):
        return ImportItem.objects.select_related('import_order')
...
class ExportItemListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        queryset = ExportItem.objects.select_related('export_order')
...
class ExportItemDetailView(generics.RetrieveAPIView):
    ...
    def get_queryset(self):
        return ExportItem.objects.select_related('export_order')
