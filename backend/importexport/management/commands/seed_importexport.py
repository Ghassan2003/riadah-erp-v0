...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        import_items_data = [
            ...
            {'order_idx': 0, 'product_name': 'محرك كهربائي صناعي 75 حصان', 'description': 'محرك كهربائي صناعي 75 حصان', 'hs_code': '8501.52', 'quantity': Decimal('5'), 'unit_price': Decimal('3000.00'), 'customs_duty_rate': Decimal('15.00'), 'unit': 'piece', 'country_of_origin': 'الصين'},
            {'order_idx': 0, 'product_name': 'صمام تحكم هيدروليكي', 'description': 'صمام تحكم هيدروليكي', 'hs_code': '8481.20', 'quantity': Decimal('50'), 'unit_price': Decimal('180.00'), 'customs_duty_rate': Decimal('10.00'), 'unit': 'piece', 'country_of_origin': 'الصين'},
            {'order_idx': 0, 'product_name': 'حامل محمل كروي SKF', 'description': 'حامل محمل كروي SKF', 'hs_code': '8482.10', 'quantity': Decimal('200'), 'unit_price': Decimal('75.00'), 'customs_duty_rate': Decimal('5.00'), 'unit': 'piece', 'country_of_origin': 'الصين'},
            # Items for IMP-2025-002 (3 items)
            {'order_idx': 1, 'product_name': 'جهاز قياس ضغط رقمي', 'description': 'جهاز قياس ضغط رقمي', 'hs_code': '9026.20', 'quantity': Decimal('10'), 'unit_price': Decimal('1200.00'), 'customs_duty_rate': Decimal('5.00'), 'unit': 'piece', 'country_of_origin': 'ألمانيا'},
            {'order_idx': 1, 'product_name': 'محلل غازات محمول', 'description': 'محلل غازات محمول', 'hs_code': '9027.80', 'quantity': Decimal('3'), 'unit_price': Decimal('4500.00'), 'customs_duty_rate': Decimal('15.00'), 'unit': 'piece', 'country_of_origin': 'ألمانيا'},
            {'order_idx': 1, 'product_name': 'مولد كهربائي احتياطي 500 كيلو فولت أمبير', 'description': 'مولد كهربائي احتياطي 500 كيلو فولت أمبير', 'hs_code': '8501.61', 'quantity': Decimal('1'), 'unit_price': Decimal('4000.00'), 'customs_duty_rate': Decimal('15.00'), 'unit': 'piece', 'country_of_origin': 'ألمانيا'},
            # Items for IMP-2025-003 (2 items)
            {'order_idx': 2, 'product_name': 'شريحة إلكترونية متحكم دقيق ARM', 'description': 'شريحة إلكترونية متحكم دقيق ARM', 'hs_code': '8542.31', 'quantity': Decimal('500'), 'unit_price': Decimal('12.00'), 'customs_duty_rate': Decimal('0.00'), 'unit': 'piece', 'country_of_origin': 'اليابان'},
            {'order_idx': 2, 'product_name': 'حساس درجة حرارة صناعي PT100', 'description': 'حساس درجة حرارة صناعي PT100', 'hs_code': '9025.19', 'quantity': Decimal('100'), 'unit_price': Decimal('35.00'), 'customs_duty_rate': Decimal('5.00'), 'unit': 'piece', 'country_of_origin': 'اليابان'},
        ]
        ...
        export_items_data = [
            ...
            {'order_idx': 0, 'product_name': 'وحدة تبريد صناعية 10 طن', 'description': 'وحدة تبريد صناعية 10 طن', 'hs_code': '8418.69', 'quantity': Decimal('2'), 'unit_price': Decimal('8500.00'), 'unit': 'piece'},
            {'order_idx': 0, 'product_name': 'مضخة مياه غاطسة 5 حصان', 'description': 'مضخة مياه غاطسة 5 حصان', 'hs_code': '8413.70', 'quantity': Decimal('5'), 'unit_price': Decimal('2200.00'), 'unit': 'piece'},
            {'order_idx': 0, 'product_name': 'لوحة تحكم كهربائية PLC', 'description': 'لوحة تحكم كهربائية PLC', 'hs_code': '8537.10', 'quantity': Decimal('2'), 'unit_price': Decimal('2750.00'), 'unit': 'piece'},
            # Items for EXP-2025-002 (3 items)
            {'order_idx': 1, 'product_name': 'مذيب صناعي Xylene', 'description': 'مذيب صناعي Xylene', 'hs_code': '2902.44', 'quantity': Decimal('500'), 'unit_price': Decimal('18.00'), 'unit': 'liter'},
            {'order_idx': 1, 'product_name': 'مواد تشحيم صناعية كالسيوم', 'description': 'مواد تشحيم صناعية كالسيوم', 'hs_code': '2710.19', 'quantity': Decimal('200'), 'unit_price': Decimal('25.00'), 'unit': 'liter'},
            {'order_idx': 1, 'product_name': 'مواد مانعة للتآكل', 'description': 'مواد مانعة للتآكل', 'hs_code': '3811.11', 'quantity': Decimal('100'), 'unit_price': Decimal('42.00'), 'unit': 'kilogram'},
        ]
