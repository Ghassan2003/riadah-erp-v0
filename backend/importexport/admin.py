...
class ImportItemInline(admin.TabularInline):
    model = ImportItem
    extra = 0
    fields = ('product_name', 'description', 'hs_code', 'quantity', 'unit_price', 'total_price', 'customs_duty_rate', 'customs_amount', 'unit')
...
class ExportItemInline(admin.TabularInline):
    model = ExportItem
    extra = 0
    fields = ('product_name', 'description', 'hs_code', 'quantity', 'unit_price', 'total_price', 'unit')
...
class ImportItemAdmin(admin.ModelAdmin):
    list_display = ('import_order', 'product_name', 'description', 'quantity', 'unit_price', 'total_price', 'customs_duty_rate')
    list_filter = ('unit',)
    search_fields = ('description', 'hs_code', 'product_name', 'import_order__order_number')
...
class ExportItemAdmin(admin.ModelAdmin):
    list_display = ('export_order', 'product_name', 'description', 'quantity', 'unit_price', 'total_price')
    list_filter = ('unit',)
    search_fields = ('description', 'hs_code', 'product_name', 'export_order__order_number')
