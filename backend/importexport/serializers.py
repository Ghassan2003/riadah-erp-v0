...
class ImportItemListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ImportItem
        fields = (
            'id', 'import_order', 'order_number', 'product_name',
...
class ImportItemCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ImportItem
        fields = (
            'import_order', 'product_name', 'description', 'hs_code',
...
class ExportItemListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ExportItem
        fields = (
            'id', 'export_order', 'order_number', 'product_name',
            'description', 'hs_code', 'quantity', 'unit_price', 'total_price',
...
class ExportItemCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ExportItem
        fields = (
            'export_order', 'product_name', 'description', 'hs_code',
