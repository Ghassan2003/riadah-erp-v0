...
test_ep GET "/api/assets/assets/" "" "" "Assets"
test_ep GET "/api/assets/stats/" "" "" "Assets Stats"
test_ep GET "/api/contracts/contracts/" "" "" "Contracts"
...
test_ep GET "/api/assets/assets/" "$TOKEN" "" "Assets"
test_ep GET "/api/assets/stats/" "$TOKEN" "" "Assets Stats"
test_ep GET "/api/contracts/contracts/" "$TOKEN" "" "Contracts"
