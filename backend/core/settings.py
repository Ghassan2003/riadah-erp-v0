...
ALLOWED_HOSTS = os.environ.get(
    ...
    'localhost,127.0.0.1,backend,frontend,testserver'
).split(',')

# Application definition
INSTALLED_APPS = [
    # Third-party ASGI apps (daphne must be before staticfiles)
    'daphne',
    'channels',
...
CACHES = {
    ...
    'analytics': {
        'BACKEND': os.environ.get(
            'ANALYTICS_CACHE_BACKEND',
            'django.core.cache.backends.locmem.LocMemCache'
        ),
        'LOCATION': os.environ.get('ANALYTICS_CACHE_LOCATION', 'analytics-cache'),
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {'NAME': 'core.validators.SequentialCharsValidator'},
]
...
CORS_ALLOW_HEADERS = [
    ...
    'x-requested-with', 'x-csrftoken', 'x-device-id',
]
