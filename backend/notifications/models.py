...
class Notification(models.Model):
    ...
    @staticmethod
    def notify_by_role(role, title, message, notification_type='info', link='', sender=None, priority='normal'):
    ...
    @staticmethod
    def notify_by_roles(roles, title, message, notification_type='info', link='', sender=None, priority='normal'):
