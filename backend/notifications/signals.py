...
def notify_low_stock(product, threshold=None):
    ...
    DISABLED: inventory.Product FK has been removed from dependent modules.
    This handler is kept as a no-op for backwards compatibility.
    """
    # NOTE: inventory integration disabled — no product.quantity or product.name available
    pass
